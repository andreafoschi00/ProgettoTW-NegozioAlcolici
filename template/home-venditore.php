    ...
    <div class="row">
        ...
        <div class="col-12 col-md-10">
            <ul class="nav nav-pills">
                ...
                <li class="nav-item col-6 col-md-3">
                    <a class="nav-link mt-2 mx-2 text-center text-white bg-dark" href="amministrazione.php">Amministrazione</a>
                </li>
                <li class="nav-item col-6 col-md-3">
                    <a class="nav-link mt-2 mx-2 text-center text-white bg-dark" href="profilo.php">Profilo</a>
                </li>
            </ul> 
        </div>
        <div class="col-md-1"></div>
